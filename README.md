...
This is a Python script for use with Autodesk Maya.  It's a crowd system tool with a fully featured UI that artists can use to create bug swarms, migrating animals and so on within their scene.  I've added [a few extra twists](https://vimeo.com/72970980) inspired by scenes from recent movies too. ;)
